#
# This is an example script to open a project and 
# show basic information from Poky by a batch script.
# by Woonghee Lee, Ph.D. (woonghee.lee@ucdenver.edu)
#
# To run this batch script:
#   In the terminal,
#     $ poky -b basic_batch.py

import __main__
s = __main__.main_session
if s.open_file('/path/to/my/project.proj') != 1:
...
# If you want to close Poky automatically, uncomment below.
#s.quit_poky()
